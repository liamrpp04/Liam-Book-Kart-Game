...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        bool m_InAir = false;
        // Nitro vals 
        [HideInInspector] public bool isUsingNitro;
        ...
        void FixedUpdate()
        {
            ...
            if (m_CanMove)
            {
                MoveVehicle(isUsingNitro? true: Input.Accelerate, Input.Brake, Input.TurnInput);
            }
            GroundAirbourne();
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            Vector3 movement = fwd * accelInput * finalAcceleration * ((m_HasCollision || GroundPercent > 0.0f || isUsingNitro) ? 1.0f : 0.0f);
