...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        void FixedUpdate()
        {
            ...
            if (m_CanMove)
            {
                MoveVehicle(using_nitro ? true : Input.Accelerate, Input.Brake, Input.TurnInput);
            }
            GroundAirbourne();
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            Vector3 movement = fwd * accelInput * finalAcceleration * ((m_HasCollision || GroundPercent > 0.0f || using_nitro) ? 1.0f : 0.0f);
